...
def sampling_loop(train_dataloader, opts):
    ...
    U.load_state_dict(torch.load(os.path.join(opts.checkpoint_dir,'diffusion.pth'))) #Load diffusion model checkpoint
...
def create_parser():
    ...
    parser.add_argument('--data_preprocess', type=str, default='vanilla', help='data preprocess scheme [resize_only|vanilla]')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoints_ddpm')
    parser.add_argument('--sample_dir', type=str, default='./ddpm')
