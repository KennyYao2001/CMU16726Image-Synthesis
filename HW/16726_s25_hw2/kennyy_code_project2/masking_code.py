...
# Modified by Zhixuan Liu: 2/12/25
...
def save_masks(im1name, im2name):
    ...
    print("  ", name2 + "_mask.png")
    print("  ", name1 + "_newsource.png")
    return source_mask, target_mask, source_im

if __name__ == "__main__":
    # Parse command-line arguments.
    parser = argparse.ArgumentParser(
        description="Interactive Masking Tool:\n"
                    "Create a mask on a source image and paste it onto a target image.\n"
                    "Key commands (in the source image window):\n"
                    "  p - Toggle polygon mode\n"
                    "  q - Finalize polygon and select center (when in polygon mode)\n"
    ...
    save_masks(args.source_image, args.target_image)
